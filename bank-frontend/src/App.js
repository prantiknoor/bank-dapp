...
function App() {
  ...
  const contractAddress = "0x543Dbf993615Ae088ec04a023477acFe22B1b34c";
  ...
  const getBankBalance = async () => {
    try {
      if (window.ethereum) {
        ...
        let bankBalance = await bankContract.getBankBalance();
        console.log('bankBalance: ',bankBalance);
        setCurrentBankBalance(utils.formatEther(bankBalance));
      } else {
        console.log("Ethereum object not found, install Metamask.");
        setError("Please install a MetaMask wallet to use our bank.");
      }
      ...
      {isBankerOwner && (
        <section className="bank-owner-section">
          ...
          <div className="p-10">
            ...
            <br></br>
            <button className="btn-purple rounded" onClick={getBankBalance}>
              Get Bank Balance
            </button>
          </div>
        </section>
